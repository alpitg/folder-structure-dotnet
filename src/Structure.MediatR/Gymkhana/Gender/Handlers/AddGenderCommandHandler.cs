...
{
    public class AddGenderCommandHandler : IRequestHandler<AddGenderCommand, ServiceResponse<GenderDto>>
    {
        private readonly IGenderRepository _GenderRepository;
        private readonly IUnitOfWork<StructureDbContext> _uow;
        private readonly IMapper _mapper;
        private readonly ILogger<AddGenderCommandHandler> _logger;
        
        public AddGenderCommandHandler(
           IGenderRepository GenderRepository,
            IMapper mapper,
            IUnitOfWork<StructureDbContext> uow,
            ILogger<AddGenderCommandHandler> logger
            )
        {
